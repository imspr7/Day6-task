...
const movieDetails = new movie("Black Panther","Marvel Studios", "PG-13");
...
const movie1 = new movies("Black Panther","Marvel Studios");
console.log(movie1);
...
const movie2 = new movies("Black Panther","Marvel Studios","PG-14");
console.log(movie2);
...
let moviee1 = new Moviee("Black Panther", "Marvel Studios", "PG");
let moviee2 = new Moviee("Black Panther-2", "Marvel Studios", "PG");
...
// Moviee {title: 'Black Panther', studio: 'Marvel Studios', rating: 'PG'}
// Moviee {title: 'Black Panther-2', studio: 'Marvel Studios', rating: 'PG'} 
...
class Moviez {
    ...
    let person1 = new Person("Sree", "pathi",28, "mechanical", "sreepathirajendran@gmail.com", 7904834187, "coimbatore");
    let person2 = new Person("harish","ramar", 27, "IT", "harishramar@gmail.com", 9876543210, "chennai");
...
//             email: sreepathirajendran@gmail.com
//             mobile: 7904834187
//             city: coimbatore
// Oops.js:220 Name: harish ramar
//             age: 27
//             department: IT
//             email: harishramar@gmail.com
//             mobile: 9876543210
//             city: chennai
